...
vim.keymap.set('t', '<C-M-j>', '<C-\\><C-n><C-w>j', { desc = 'Switch to down window from terminal' })
vim.keymap.set('t', '<C-M-k>', '<C-\\><C-n><C-w>k', { desc = 'Switch to up window from terminal' })
vim.keymap.set('t', '<C-M-l>', '<C-\\><C-n><C-w>l', { desc = 'Switch to right window from terminal' })
vim.keymap.set('t', '<C-M-h>', '<C-\\><C-n><C-w>h', { desc = 'Switch to left window from terminal' })
